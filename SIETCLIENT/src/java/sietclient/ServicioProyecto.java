...
public class ServicioProyecto extends AbstractSessionBean {
    ...
    private ItemProyecto proyectoEdicion;
    ...
    public void editar(ItemProyecto item){
        proyectoEdicion = item;
    }

    /**
     * @return the proyectoEdicion
     */
    public ItemProyecto getProyectoEdicion() {
     ...
     */
    public void setProyectoEdicion(ItemProyecto proyectoEdicion) {
