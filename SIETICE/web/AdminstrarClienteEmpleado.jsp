...
<!--
    Document   : AdminstrarClienteEmpleado
                            ...
                            <ice:panelLayout id="panecuerpo" style="border: 1px solid rgb(0, 51, 51); height: 470px; left: 0%; top: 5px; position: relative; width: 960px">
                                <ice:panelLayout id="panelLayout2" style="border-width: 1px; border-style: solid; border-color: rgb(0, 0, 0) rgb(0, 0, 0) rgb(0, 0, 0) rgb(0, 0, 0); background-color: rgb(48, 67, 87); height: 100%; position: absolute; width: 25%">
                                    ...
                                    <ice:commandButton action="#{AdminstrarClienteEmpleado.btn_Buscar_action}" id="btn_Buscar"
                                        ...
                                        style="height: 38px; left: 20%; top: 100px; position: absolute; text-align: center; width: 60%" value="BUSCAR"/>
                                    <ice:commandButton action="#{AdminstrarClienteEmpleado.btnvolver_action}" id="btnvolver" image="/resources/volverok.png"
                                        style="height: 37px; left: 20%; top: 150px; position: absolute; width: 60%" value="Volver"/>
                                </ice:panelLayout>
                                <div align="center">
                                ...
                                <ice:panelLayout id="panelLayout55" style="border: 0px solid rgb(0, 0, 0); height: 80%; left: 30%; top: 70px; position: absolute; width: 65%">
                                    <div align="center" style="overflow:auto; width:auto; height:260px">
                                        <ice:dataTable headerClass="list-header" id="dataTable1" rowClasses="list-row-even,list-row-odd"
                                            style="font-size: 12px; overflow: auto; position: relative; width: 100%"
                                            value="#{AdminstrarClienteEmpleado.modelClientes}" var="c">
                                            <h:column id="column1">
                                            ...
                                            <h:column id="column7">
                                                ...
                                                <f:facet name="header">
                                                    <h:outputText id="outputText14" value="Estado Civil"/>
                                                </f:facet>
                                            </h:column>
                                            <h:column id="column8">
                                                <ice:panelGrid id="gridPanel12">
                                                    <h:commandLink action="#{AdminstrarClienteEmpleado.linkActionEditar_action}" id="linkActionEditar"
                                ...
                                f:facet name="header">
                                    h:outputText id="outputText19" value="               DIRECCIÓN     "/>
                                /f:facet>
                            /h:column> -->
                                        </ice:dataTable>
                                    </div>
