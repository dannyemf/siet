...
<jsp:root version="2.1" xmlns:f="http://java.sun.com/jsf/core" xmlns:h="http://java.sun.com/jsf/html" xmlns:ice="http://www.icesoft.com/icefaces/component" xmlns:jsp="http://java.sun.com/JSP/Page">
    ...
    <f:view>
        <html id="html1">
            <head id="head1" title="SIET - Administrar Proyectos [ Empleado ]">
                        ...
                        <ice:panelLayout id="panecuerpo" style="border: 1px solid rgb(0, 51, 51); height: 75%; left: 10%; top: 25%; position: absolute; width: 80%">
                            <ice:panelLayout id="panelLayout2" style="border-width: 1px; border-style: solid; border-color: rgb(0, 0, 0) rgb(0, 0, 0) rgb(0, 0, 0) rgb(0, 0, 0); background-color: rgb(48, 67, 87); height: 100%; position: absolute; width: 25%">
                                <ice:outputLabel id="outputLabel1"
                                    style="color: rgb(255, 255, 255); top: 50px; position: absolute; text-align: center; width: 100%" value="Buscar por PROYECTO"/>
                                ...
                                <ice:commandButton action="#{AdministrarProyectoEmpleado.btnvolver_action}" id="btnvolver" image="/resources/volverok.png"
                                ...
                                <div align="center" style="overflow:auto; width:auto; height:260px">
                                    <ice:dataTable headerClass="list-header"  id="dataTable1" rowClasses="list-row-even,list-row-odd" style=" font-size: 12px; position: relative"
                                        ...
                                        <h:column id="column1">
                                            ...
                                            <f:facet name="header">
                                                <h:outputText id="outputText2"  value="Propietario"/>
                                            </f:facet>
                                        </h:column>
                                        <h:column id="column2">
