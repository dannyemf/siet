            ...
            <body id="body1" style="-rave-layout: grid">
                <ice:form id="formEditCliente">
                    <ice:panelLayout id="panetodo" style="border-width: 0px; border-style: dotted; height: 100%; left: 0px; top: 0px; position: absolute; width: 100%">
                        ...
                        <div align="center">
                            <ice:panelLayout id="panecuerpo" style="border: 1px solid gray; background-color: rgb(255, 255, 255); height: 470px; margin-bottom: 10px; left: 0%; top: 5px; position: relative; width: 960px; -rave-layout: grid;">
                                ...
                                <ice:inputText id="txtcedula" maxlength="10" onchange="toEntero( this);" onkeyup="toEntero( this);" required="true"
                                    style="left: 30%; top: 70px; position: absolute" validator="#{EditClienteCli.txtcedula_validate}" value="#{EditClienteCli.servicioCliente.clienteEdicion.ci}"/>
                                <ice:inputText id="txtnombre" onchange="toCadena( this);" onkeyup="toCadena( this);" required="true"
                                    style="left: 30%; top: 170px; position: absolute" value="#{ServicioCliente.clienteEdicion.nombre}"/>
                                ...
                                <ice:inputText id="txtcelular" maxlength="9" onchange="toEntero( this);" onkeyup="toEntero( this);" required="true"
                                    style="left: 70%; top: 165px; position: absolute" validator="#{EditClienteCli.txtcelular_validate}" value="#{ServicioCliente.clienteEdicion.celular}"/>
                                <ice:inputText id="txtdireccion" required="true" style="left: 30%; top: 315px; position: absolute; width: 384px" value="#{ServicioCliente.clienteEdicion.direccion}"/>
                                <ice:selectOneMenu id="dropestadocivil" style="left: 30%; top: 270px; position: absolute; width: 120px" value="#{ServicioCliente.clienteEdicion.estadoCivil}">
                                    <f:selectItems id="dropdown1SelectItems1" value="#{EditarCliente.estadoCivil}"/>
                                </ice:selectOneMenu>
                                <ice:selectOneMenu id="dropsexo" style="left: 70%; top: 270px; position: absolute; width: 120px" value="#{ServicioCliente.clienteEdicion.sexo}">
                                ...
                                <ice:commandButton action="#{EditClienteCli.btnaceptar_action}" id="btnaceptar" image="/resources/btnAceptar.png"
                                    style="height: 48px; left: 70%; top: 390px; position: absolute; width: 141px" value="Aceptar"/>
                                ...
                                <ice:outputLabel id="label13" style="font-size: 10px; left: 30%; top: 235px; position: absolute" value="( Mínimo 5 caracteres )"/>
                                <ice:outputLabel id="label15" style="left: 144px; top: 320px; position: absolute" value="Dirección: * "/>

                                <ice:inputSecret id="secretclave" style="left: 30%; top: 214px; position: absolute" value="#{EditClienteCli.clave}"/>
                                <ice:inputSecret id="secretconfclave" style="left: 70%; top: 214px; position: absolute" value="#{EditClienteCli.confirmclave}"/>
                                ...
                                <ice:message for="txtdireccion" id="message6" showDetail="false" showSummary="true" style="color: rgb(255, 0, 0); left: 30%; top: 290px; position: absolute"/>
                                <ice:message for="secretclave" id="message7" showDetail="false" showSummary="true" style="color: rgb(255, 0, 0); left: 30%; top: 190px; position: absolute"/>
                                <ice:message for="secretconfclave" id="message8" showDetail="false" showSummary="true" style="color: rgb(255, 0, 0); left: 70%; top: 190px; position: absolute"/>
                                ...
                                <ice:outputLabel id="label1" style="left: 144px; top: 360px; position: absolute" value="Los campos Marcados con (*) son Obligatorios"/>
                                <ice:commandButton action="#{EditClienteCli.btnvolver1_action}" id="btnvolver1" image="/resources/btnVolver.png"
                                    partialSubmit="true" style="height: 48px; left: 15%; top: 390px; position: absolute; width: 142px" value="volver"/>
                            </ice:panelLayout>
                        </div>
                    </ice:panelLayout>
                </ice:form>
