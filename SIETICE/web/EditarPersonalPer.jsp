                    ...
                    <ice:panelLayout id="panetodo"
                        ...
                        <div align="center">
                            <ice:panelLayout id="panecuerpo" style="border: 1px solid #999999; height: 600px; left: 0%; top: 5px; position: relative; width: 960px; -rave-layout: grid;">
                                ...
                                <ice:outputLabel id="label9" style="left: 144px; top: 344px; position: absolute; width: 95px" value="Clave: *"/>
                                ...
                                <ice:inputSecret id="secretclave" partialSubmit="true" redisplay="true" style="left: 286px; top: 342px; position: absolute"
                                ...
                                <ice:inputText id="txtusuario" required="true" style="left: 286px; top: 310px; position: absolute" value="#{ServicioEmpleado.empleadoEdicion.usuario}"/>
                                ...
                                <ice:message for="txtusuario" id="message7" showDetail="false" showSummary="true" style="color: rgb(255, 0, 0); left: 456px; top: 312px; position: absolute; width: 397px"/>
                                <ice:message for="secretclave" id="msxsecretclav" showDetail="false" showSummary="true" style="color: rgb(255, 0, 0); left: 456px; top: 344px; position: absolute; width: 397px"/>
                                ...
                                <ice:outputLabel id="label14" style="left: 144px; top: 376px; position: absolute; width: 125px" value="Confirmar Clave: *"/>
                                <ice:inputSecret id="secretclaveconf" partialSubmit="true" redisplay="true" required="#{ServicioEmpleado.requiredConfirmClave}"
                                    style="left: 286px; top: 374px; position: absolute" validator="#{ServicioEmpleado.confclave_validate}" value="#{ServicioEmpleado.confirmclave}"/>
                                <ice:message for="secretclaveconf" id="msxsecretclav1" style="color: rgb(255, 0, 0); left: 456px; top: 376px; position: absolute; width: 397px"/>
                            </ice:panelLayout>
                        </div>
                    </ice:panelLayout>
                </ice:form>
