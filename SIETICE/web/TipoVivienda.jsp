    ...
    <f:view>
        <html id="html1">
            ...
            <body id="body1" style="-rave-layout: grid">
                <ice:form id="form1">
                    <ice:panelLayout id="panetodo" style="border-width: 0px; border-style: dotted; height: 750px; left: 0%; top: 0%; position: absolute; width: 100%">
                        <div align="center">
                        ...
                        <div align="center">
                            <ice:panelLayout id="panecuerpo" style="border: 1px solid rgb(0, 51, 51); height: 700px; left: 0%; top: 5px; position: relative; width: 960px; -rave-layout: grid;">
                                ...
                                <ice:graphicImage alt="Plano no encontrado..." height="669" id="graphicImage11"
                                    style="color: rgb(255, 0, 0); font-weight: bold; height: 650px; left: 500px; top: 50px; position: absolute"
