/*
 * PaginaResultadoProyectoCli.java
 *
 ...
 */
public class PaginaResultadoProyectoCli extends AbstractPageBean {

    private ProyectoCliente proyecto = null;
     ...
     */
    public PaginaResultadoProyectoCli() {
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("PaginaResultadoProyectoCli Initialization Failure", e);
     ...
     * @return the proyecto
     */
    public ProyectoCliente getProyecto() {
        Cliente cliente = getServicioCliente().getClienteLogeado();
        proyecto = getServicioProyecto().buscarProyectoClientePor(cliente);
        return proyecto;
    }
     ...
     */
    public void setProyecto(ProyectoCliente proyecto) {
