 ...
 *
 * @version AdministradorSistema.java
 * @version Created on 08/06/2010, 12:08:18 PM
 * @author Administrator
 */

public class PaginaAdministradorSistema extends AbstractPageBean {
     ...
     */
    public PaginaAdministradorSistema() {
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("AdministradorSistema Initialization Failure", e);
 ...
 public RecursoFile getRecursoAyuda() {
    ...
    public String btnclienteregis_action() {
    ...
    public String admintipovivienda_action() {
        return "case3";
    }

    public String btnGenerarReportes_action() {
    ...
    public String btnAuditoria_action() {
        //return null means stay on the same page
        return "case-auditoria";
    }

    public String btnsalir1_action() {
        //return null means stay on the same page
        return "case-respaldos";
    }

    public String btnproyecto1_action() {
        //return null means stay on the same page
     return "case-proyecto";
    }

    public String btnRespaldos_action() {
        //return null means stay on the same page
        return "case-respaldos";
    }
