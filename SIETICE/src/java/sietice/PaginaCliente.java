 ...
 *
 * @version Cliente.java
 * @version Created on 01/06/2010, 11:16:51 PM
 * @author Administrator
 */

public class PaginaCliente extends AbstractPageBean {
    ...
    public void init() {
        ...
        try {
            ...
            log("Cliente Initialization Failure", e);
    ...
    public String btnsubirdoc_action() {
        getServicioDocumentacion().nuevo();
        //getServicioDocumentacion().editar(getServicioDocumentacion().getDodumentacionLogeado().getImgCedula());
        return "case-subirdoc";
    }

    public String btnmodificarinf_action() {

         Cliente c = (Cliente)getServicioCliente().getClienteLogeado();
        getServicioCliente().editar(c);
        return "case1";
    }

    public String btnsalir_action() {
        getServicioCliente().salir();
        return "case-salir";
    }

    public String btntipovivienda_action() {
       getServicioProyecto().nuevoProyectoCliente();
    ...
    public String btn_selcproyecto_action() {
