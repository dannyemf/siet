...
public class AdministrarProyectoEmpleado extends AbstractPageBean {
     ...
     */
    public AdministrarProyectoEmpleado() {
    }
     private ArrayDataModel modelProyecto = new ArrayDataModel();

    public ArrayDataModel getModelProyecto(){
        modelProyecto = new ArrayDataModel(getServicioProyecto().listarProyectosClientes().toArray());
   ...
   public ServicioProyecto getServicioProyecto() {
    ...
    public String linkActionEditar_action() {
        ...
        getServicioProyecto().editarProyectoEmpleado(p);
