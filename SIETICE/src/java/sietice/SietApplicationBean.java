 ...
 *
 * Created on 09/10/2010, 10:55:02 AM
 * Copyright LENIN
 */
package sietice;
 ...
 * this class.</p>
 */
public class SietApplicationBean extends AbstractApplicationBean {

    public static String contextPath = "No Iniciado";
     ...
     */
    public SietApplicationBean() {
        contextPath = getRequestMap().get("host").toString();
    }
    ...
    public void init() {
        ...
        //contextPath = ses.getServletContext().getRealPath("/");
    }
